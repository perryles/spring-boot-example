package com.plumroc.springbootmail.service.impl;


import com.plumroc.springbootmail.config.MailConfigProperty;
import com.plumroc.springbootmail.service.MailService;
...
public class MailServiceImpl implements MailService {
    ...
    public void sendSimpleMail(String to, String subject, String content) {
        log.info("[邮件发送] >> 普通邮件发送开始 to : {} , subject : {} ", to, subject);
        ...
        try {
            ...
            log.info("[邮件发送] >> 普通邮件发送成功 >> to : {} , subject : {}", to, subject);
        } catch (MailAuthenticationException e) {
            log.info("[邮件发送] >> 发件人账户认证异常 >> 请检查发件人账户配置 to : {} , subject : {} , stack ：{}", to, subject, e);
        } catch (Exception e) {
            log.info("[邮件发送] >> 普通邮件未知异常 >> to : {} , subject : {} , stack ：{}", to, subject, e);
        }
    ...
    public void sendHtmlMail(String to, String subject, String content) {
        log.info("[邮件发送] >> HTML邮件发送开始 to : {} , subject : {} ", to, subject);
        ...
        try {
            ...
            mailSender.send(message);
            log.info("[邮件发送] >> HTML邮件发送成功 to : {} , subject : {}", to, subject);
        } catch (MailAuthenticationException e) {
            log.info("[邮件发送] >> 发件人账户认证异常 >> 请检查发件人账户配置 to : {} , subject : {} , stack ：{}", to, subject, e);
        } catch (Exception e) {
            log.info("[邮件发送] >> HTML邮件未知异常 >> to : {} , subject : {} , stack ：{}", to, subject, e);
        }
    }
    ...
    public void sendAttachmentMail(String to, String subject, String content, List<String> attachmentPathList) {
        log.info("[邮件发送] >> 带附件邮件发送开始 to : {} , subject : {} , attachmentPath : {}", to, subject, attachmentPathList);
        if (CollectionUtils.isEmpty(attachmentPathList)) {
            log.info("[邮件发送] >> 带附件邮件发送结束 >> 附件信息为空 >> to : {} , subject : {}", to, subject);
            return;
        }
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper;
        try {
            ...
            mailSender.send(message);
            log.info("[邮件发送] >> 带附件邮件发送成功 >> to : {} , subject : {}", to, subject);
        } catch (MailAuthenticationException e) {
            log.info("[邮件发送] >> 发件人账户认证异常 >> 请检查发件人账户配置 to : {} , subject : {} , stack ：{}", to, subject, e);
        } catch (Exception e) {
            log.info("[邮件发送] >> 带附件邮件未知异常 >> to : {} , subject : {} , stack ：{}", to, subject, e);
        }
    }
    ...
    public void sendPictureMail(String to, String subject, String content, String picturePath, String pictureId) {
        log.info("[邮件发送] >> 带图片邮件发送开始 to : {} , subject : {} , picturePath : {}", to, subject, picturePath);
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper;
        try {
            helper = new MimeMessageHelper(message, true);
            ...
            mailSender.send(message);
            log.info("[邮件发送] >> 带图片邮件发送成功 >> to : {} , subject : {} , picturePath : {}", to, subject, picturePath);
        } catch (MailAuthenticationException e) {
            log.info("[邮件发送] >> 发件人账户认证异常 >> 请检查发件人账户配置 to : {} , subject : {} , picturePath : {} , stack ：{}", to, subject, picturePath, e);
        } catch (Exception e) {
            log.info("[邮件发送] >> 带图片邮件未知异常 >> to : {} , subject : {} , picturePath : {}  , stack ：{}", to, subject, picturePath, e);
        }
    }
